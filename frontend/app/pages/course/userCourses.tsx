...
export function UserCoursesPage() {
  const { userInfoData, allCoursesData, myCoursesData, errorObject } = useLoaderData();

  console.debug(allCoursesData)
  return (
    <section id="content">
      <GlobalError error={errorObject} />
      <h2><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
