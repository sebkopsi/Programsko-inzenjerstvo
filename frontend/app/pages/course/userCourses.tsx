...
export function listCourses(data: any) {
  return (
    <section id="all-courses" className="cardList section">
      <ul>
        {data != null ? data.data.map((course: any) =>
...
export function UserCoursesPage() {
  const { allCoursesData, myCoursesData } = useLoaderData();
